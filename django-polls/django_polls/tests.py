...
class QustionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        whose date pub_date is withing the last day
        """
...
def create_question(question_text, days):
    ...
    the given number of 'days' offset to now (negative for question published in the past, positive for questions
...
class QuestionIndexViewTest(TestCase):
    ...
    def test_past_question(self):
        """
        Question with a pub_date in the past are
    ...
    def test_future_question(self):
        ...
        arean't displayed on the index page.
        """
    ...
    def test_future_question_and_past_question(self):
        ...
        only past question are displayed.
        """
        question = create_question(question_text="Past question",
                                   days=-30)
        create_question(question_text="Future question.", days=30)
    ...
    def test_two_past_question(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertQuerySetEqual(response.context["latest_question_list"],[question3, question2 ,question1])
